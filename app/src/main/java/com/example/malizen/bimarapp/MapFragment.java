...
public class MapFragment extends Fragment implements LocationEngineListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMapView.getMapAsync(mapboxMap -> {
            ...
            //Add marker to map
            addMarkerToMapViewAtPosition(Constants.Razi);
            addMarkerToMapViewAtPosition(Constants.QANON);
            addMarkerToMapViewAtPosition(Constants.DASTJERDI);
            addMarkerToMapViewAtPosition(Constants.HELALAHMAR);
            addMarkerToMapViewAtPosition(Constants.SHIRODI);
            addMarkerToMapViewAtPosition(Constants.GHAFARI);
